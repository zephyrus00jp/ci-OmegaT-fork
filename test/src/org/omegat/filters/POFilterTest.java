...
public class POFilterTest extends TestFilterBase {
    ...
    public void testLoad() throws Exception {
        ...
        String[] noComment = { SegmentProperties.COMMENT, null };

        checkMultiStart(fi, f);
        checkMultiProps("source1", null, "some context", null, null, SegmentProperties.COMMENT, comment);
        checkMultiProps("source2", null, "", null, null, noComment);
        ...
        checkMultiProps("source4", null, "one more context", null, null, noComment);
        checkMultiProps("source4", null, "one more context[1]", null, null, SegmentProperties.COMMENT,
